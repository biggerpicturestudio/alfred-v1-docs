...
Alfred is the CMS that serves the UI as easy as possible to a customer (Alfred User) with one goal - easy content management to handle custom front page design. Custom design with custom CMS solutions. 
...
Alfred UI can look different per each project but under the hood there are constant rules and components or microcomponents that allow developers to deliver the content management easy for the end users. Possibilities are infinite - you can create a new module, new components, new micro components per project and deliver the best UI for any customer.
